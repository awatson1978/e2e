...
directories.forEach(function (directory) {
  var found;
  if(process.env.SOURCE_TESTS_DIR){
    found = Mocha.utils.lookupFiles(process.env.SOURCE_TESTS_DIR + '/' + directory, ['js'], true);
  }else{
    found = Mocha.utils.lookupFiles('specs/' + directory, ['js'], true);
  }
